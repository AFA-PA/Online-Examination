...
ALTER TABLE COURSEREGISTRATION_USER ADD CONSTRAINT FK_COURSEREGISTRATION_USER_courseRegistrations_id FOREIGN KEY (courseRegistrations_id) REFERENCES COURSEREGISTRATION (id)
