...
CREATE TABLE UserRegistration (registeredUsers_ID BIGINT NOT NULL, user_id BIGINT NOT NULL, reg_id BIGINT NOT NULL, PRIMARY KEY (registeredUsers_ID, user_id, reg_id))
