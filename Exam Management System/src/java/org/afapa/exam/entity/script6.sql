...
CREATE TABLE UserRegistration (reg_id BIGINT NOT NULL, registeredUsers_ID BIGINT NOT NULL, courseRegistrations_id BIGINT NOT NULL, PRIMARY KEY (reg_id, registeredUsers_ID, courseRegistrations_id))
...
ALTER TABLE UserRegistration ADD CONSTRAINT FK_UserRegistration_courseRegistrations_id FOREIGN KEY (courseRegistrations_id) REFERENCES ExamManDb.CourseRegistration (id)
