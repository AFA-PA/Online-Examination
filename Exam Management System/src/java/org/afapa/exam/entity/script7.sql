...
CREATE TABLE UserRegistration (id BIGINT NOT NULL, registeredUsers_ID BIGINT NOT NULL, user_id BIGINT NOT NULL, reg_id BIGINT NOT NULL, PRIMARY KEY (id, registeredUsers_ID, user_id, reg_id))
...
ALTER TABLE UserRegistration ADD CONSTRAINT FK_UserRegistration_user_id FOREIGN KEY (user_id, reg_id) REFERENCES CourseRegistration (id, id)
ALTER TABLE UserRegistration ADD CONSTRAINT FK_UserRegistration_id FOREIGN KEY (id) REFERENCES CourseRegistration (id)
