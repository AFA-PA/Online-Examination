...
import org.afapa.exam.beans.OrganizationFacade;
...
public class OrganizationController implements Serializable {
    ...
    @EJB
    private org.afapa.exam.beans.OrganizationFacade ejbFacade;
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("OrganizationUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("OrganizationDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public void newDepartment() {
        if (current.getDepartments() == null) {
            current.setDepartments(new HashSet<>());
        }
        Department dep = new Department();
        dep.setOrganization(current);
        getSelected().getDepartments().add(dep);
    }
