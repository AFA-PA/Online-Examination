...
import org.afapa.exam.beans.PrivilegeFacade;
...
public class PrivilegeController implements Serializable {
    ...
    @EJB
    private org.afapa.exam.beans.PrivilegeFacade ejbFacade;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("PrivilegeDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Privilege getPrivilege(java.lang.Long id) {
