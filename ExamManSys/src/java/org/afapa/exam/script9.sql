...
CREATE TABLE DEPARTMENT (ID BIGINT AUTO_INCREMENT NOT NULL, CREATEDODATE DATE, NAME VARCHAR(255), ORGANIZATION_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE ORGANIZATION (ID BIGINT AUTO_INCREMENT NOT NULL, CREATEDONDATE DATE, NAME VARCHAR(255), CREATEDBY_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE EXAMTAKEN (ID BIGINT NOT NULL, EXAM_ID BIGINT, TAKER_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE COURSE (ID BIGINT AUTO_INCREMENT NOT NULL, CODE VARCHAR(255), NAME VARCHAR(255), DEPARTMENT_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE EXAM (ID BIGINT AUTO_INCREMENT NOT NULL, DURATION LONGBLOB, NAME VARCHAR(255), STARTTIME TIME, COURSE_ID BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE QUESTION ADD CONSTRAINT FK_QUESTION_EXAM_ID FOREIGN KEY (EXAM_ID) REFERENCES EXAM (ID)
ALTER TABLE DEPARTMENT ADD CONSTRAINT FK_DEPARTMENT_ORGANIZATION_ID FOREIGN KEY (ORGANIZATION_ID) REFERENCES ORGANIZATION (ID)
...
ALTER TABLE EXAM ADD CONSTRAINT FK_EXAM_COURSE_ID FOREIGN KEY (COURSE_ID) REFERENCES COURSE (ID)
